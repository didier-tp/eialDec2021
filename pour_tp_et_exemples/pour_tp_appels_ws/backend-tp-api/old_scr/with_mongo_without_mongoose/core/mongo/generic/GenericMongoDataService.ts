...
import { MyMongoConnection } from "../../../db-connections/GenericMongoConnection";
...
export class GenericMongoDataService<T,ID> implements BasicCrudService<T,ID>{
    ...
    private dB() : Promise<Db>{
        return new Promise((resolve,reject) => {
            let  myMongoConnection : MyMongoConnection = myAppConnectionMap.getConnection(this.connectionName) as MyMongoConnection;
